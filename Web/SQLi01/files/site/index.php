...
<html>
	...
	<body>
		<div class="row">
			...
			<?php if($authent){	?>
				<p>Felicitation le flag de validation est : <b> 46db9636eca141a3_sqlbasicpwn_898420345145e89e </b></p>
			<?php }else{ ?>
				...
				<form method="POST" action>
					 <div class="form-group">
					  ...
					  <div class="form-group">
					    ...
					    <input type="password" class="form-control" id="password" name="password" placeholder="EthicalHacking">
					  </div>
					  <div class="form-group">
